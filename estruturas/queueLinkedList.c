/*ref: https://www.geeksforgeeks.org/queue-linked-list-implementation/  (adapted)*/
...
#include <stdlib.h>
#include <limits.h>
#include "../estruturas/queueLinkedList.h"

// Count Globals
int insertionsQLL;
int removalsQLL;
int countEmptyQLL;
size_t memoryAllocatedQLL;
...
Queue* createQueue()
{
    ...
    memoryAllocatedQLL += sizeof(Queue);
...
void enqueue(Queue* q, int new_data)
{
    ...
    if (q->rear == NULL) {
        ...
        memoryAllocatedQLL += sizeof(Node);
        insertionsQLL++;
        return;
    }
